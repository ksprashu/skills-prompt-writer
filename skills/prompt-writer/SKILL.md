...
When analyzing, refining, and drafting the user's prompt, you MUST adopt the appropriate persona at each stage, standardizing and organizing all generated knowledge artifacts as an OKF Knowledge Bundle. All file layouts, YAML frontmatters, indices, and log schemas are governed and specified by the standalone **[Knowledge Catalog Custom Skill](file:///Users/ksprashanth/.gemini/skills/knowledge-catalog/SKILL.md)**. You must adopt these personas:
